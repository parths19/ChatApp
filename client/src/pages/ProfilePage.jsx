...
const ProfilePage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      ...
      flex items-center justify-between max-sm:flex-col-reverse rounded-1g'>
        <form onSubmit={handleSubmit} className="flex flex-col gap-5 p-10 flex-1">
          ...
          <textarea onChange={(e) => setBio(e.target.value)} value={bio} placeholder="Write profile bio" required
            className="p-2 borderborder-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500" rows={4}>
          </textarea>

          <button type="submit" className="bg-linear-to-r from-purple-400 to-violet-600 text-white p-2 
